 ...
 * Aceitação Purchase
 */
routes.get('/purchaseStatus/get', handle(controllers.PurchaseStatusController.index))
routes.put('/purchaseStatus/accept/:id', validate(validators.PurchaseStatus), handle(controllers.PurchaseStatusController.accept))
